...
class Controller_Aa_Admin_Theme extends Layout_Aa {
    ...
    function before() {
        ...
        $actions = array(
            'aa_admin_theme/show/banner' => 'Banner',
            'aa_admin_theme/show/logo' => 'LOGO',
            'aa_admin_theme/show/rec' => '侧栏图片',
            'aa_admin_theme/index' => '页面配色',
            'aa_admin_theme/display' => '内容显示',
        );
    ...
    function action_show($format = 'banner') {
        ...
        $view['clubs']=Doctrine_Query::create()
                ->select('c.id,c.name')
                ->from('Club c')
