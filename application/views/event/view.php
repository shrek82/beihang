...
<?php else: ?>
    ...
    <div class="view_box" >
        ...
        <b>时间：</b><?php if (date('Y-m-d', strtotime($event_data['event']['start'])) == date('Y-m-d', strtotime($event_data['event']['finish']))): ?><?= date('Y年m月d日', strtotime($event_data['event']['start'])) ?>&nbsp;<?= date('H:i', strtotime($event_data['event']['start'])) ?>~<?= date('H:i', strtotime($event_data['event']['finish'])) ?><?php else: ?><?= date('Y年m月d日 H:i', strtotime($event_data['event']['start'])) ?> ~ <?= date('Y年m月d日 H:i', strtotime($event_data['event']['finish'])) ?><?php endif; ?><br>
