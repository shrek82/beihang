...
<div id="main_left" style="background-color:#F8FCFF; " >
    ...
    <div class="news_info" style="text-align:center; margin: 5px 10px; color: #999" >发布：<?= $news['create_at']; ?><?php if (isset($news['author_name']) AND trim($news['author_name'])): ?>&nbsp;&nbsp;作者：<?= $news['author_name'] ?><?php endif; ?></div>
    ...
    <?php if (isset($news['is_comment']) AND $news['is_comment']): ?>
