...
<div id="admin950">
        <form id="aa_base" action="<?= URL::query(); ?>" method="post" enctype="multipart/form-data">
                ...
                <p style="height:30px">背景图片：<input type="file" name="file">  <span style="color:#999">建议使用1440*600渐变图片</span>&nbsp;&nbsp;&nbsp;<?php if ($aaTheme['background_image']): ?><a href="/static/aa/background/<?= $aaTheme['background_image'] ?>" target="_blank" >查看已经上传图片</a><?php endif; ?></p>
