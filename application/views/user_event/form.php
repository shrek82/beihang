...
<div id="big_right">
	...
	<ul>
	    ...
	    <li><a href="<?= URL::site('event/form') ?>" class="cur" style="width:80px" target="_blank">发起活动</a></li>
	</ul>
    </div>

    <div>
	<?= View::factory('inc/event/form', compact('event', 'aa_id', 'club_id')) ?>
    </div>
