    ...
    <div>
        ...
        <div style="width:200px;float:right;border:1px solid #E3EEF8;padding:10px;">
            <ul id="aa_info">
                ...
                <li><a href="<?= URL::site('aa/constitution') ?>" class="cur">北京航空航天大学校友总会章程</a></li>
                <li style="display: none"><a href="<?= URL::site('aa/organization') ?>" >北京航空航天大学校友总会理事名单</a></li>
                <li style="display: none"><a href="<?= URL::site('aa/memorabilia') ?>" >北京航空航天大学校友总会大事记</a></li>
