...
<table border="0" cellspacing="0" cellpadding="0">
	...
	<td valign="top" style="padding:5px 10px 5px 0px;width:620px; line-height: 1.6em;color:#666">
	    ...
	    <p style="text-align:right"><a href="javascript:;" onclick="contentViewReplyCmt(<?=$c['user_id']?>,'<?= $c['realname'] ?>');" style="color:#6AADDB">回复</a></p>
	</td>
    </tr>
</table>
<?php endforeach;?>
