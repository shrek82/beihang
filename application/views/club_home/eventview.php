...
<div id="admin950">
    ...
    <div class="view_name">
        ...
        <?php if ($event_data['album']): ?>
            <div class="view_title"><span class="middle"><img src="/static/images/ico_pic.gif"></span>&nbsp;活动掠影<?php if (isset($event_data['album']['pic_num'])): ?>(<?= $event_data['album']['pic_num'] ?>张)<?php endif; ?></div>
            <div class="view_box">
