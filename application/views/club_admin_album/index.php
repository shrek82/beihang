...
<div id="admin950">
    <div style="padding: 5px 20px">
        <form action="/club_admin_album?id=<?= $_ID ?>" style="text-align: right" method="POST">
...
<script type="text/javascript">
    function del(cid){
        new candyConfirm({
            ...
            url:'<?= URL::site('club_admin_album/del?id=' . $_ID . '&album_id=') ?>'+cid,
    ...
    function editAlbum(cid) {
        new Facebox({
            title: '编辑相册',
            width:'400px',
            url:'<?= URL::site('club_admin_album/editForm?id=' . $_ID . '&album_id=') ?>'+cid,
            ok: function(){
                //提交表单
