    ...
    <div id="big_right">
        ...
        <div id="user_avatar">
            <div align="center">
                ...
                <br style="clear:both;"/>
                <form name="thumbnail" action="<?= URL::site('/user_home/avatar?zjgdebug=1') ?>" method="post"  id="thumbnailForm">
    ...
    <div id="big_right">
        ...
        <?php else: ?>
            ...
            <div id="user_avatar">
                ...
                <form name="photo" enctype="multipart/form-data" action="<?= URL::site('/user_home/avatar?zjgdebug=1') ?>" method="post">
