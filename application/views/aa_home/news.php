...
<div id="main_left">
    ...
    <div style="text-align: right;padding: 0px 20px">
        <input type="button" onclick="location.href='<?= URL::site('user_news/form?aa=' . $_ID) ?>'" value="新闻投稿" class="button_blue" style=" margin-bottom: 5px" />
    </div>
            ...
            <?php foreach ($news as $n): ?>
                <tr style="border-bottom: 1px dotted #ccc">
                    <td>
                        ...
                        <a href="<?= URL::site('aa_home/newsDetail?id=' . $_ID . '&nid=' . $n['id']) ?>" <?= $n['is_fixed'] ? 'style="color:#f30"' : ''; ?>><?= Text::limit_chars($n['title'], 30, '...'); ?></a><?php if ($n['is_fixed']): ?>&nbsp;&nbsp;<font style="color:#f60"><img src="/static/images/is_top.gif" title="置顶新闻"></font><?php endif; ?>
                    </td>
                    <td class="center">
